        ...
        <div id="main-site">
            ...
            <div id="profile">
                ...
                <div id="column-1">
                    ...
                    <a href="orders.php" class="clicked"><i class="fa-duotone fa-credit-card-front"></i>Orders</a>
                ...
                <div id="column-2">
                    ...
                    <div id="orders">
                        ...
                        <div id="order-block">
                            <div id="title">My Orders</div>

                            <div id="order-container">

                                <div id="order-status">

                                    <div data-active="yes">Ordered</div>
